            ...
            <div className="container">
                <div style={styles.content}>
                    <div style={styles.section}>
                        <h4 style={styles.title}>TalkNet</h4>
                        <p style={styles.description}>
                            Comunicación instantánea, segura y confiable para todos.
                        </p>
                    </div>

                    <div style={styles.section}>
                        <h4 style={styles.title}>Enlaces</h4>
                        <ul style={styles.list}>
                            <li><a href="#features" style={styles.link}>Características</a></li>
                            <li><a href="#download" style={styles.link}>Descargar</a></li>
                            <li><a href="#" style={styles.link}>Soporte</a></li>
                ...
                <div style={styles.bottom}>
                    <p style={styles.copyright}>
                        © {currentYear} TalkNet. Todos los derechos reservados.
                    </p>
                </div>
            </div>
        </footer>
